...
_setup_ollama() {
    ...
    echo -e "\n${BOLD}${CYAN}🖥  YÊU CẦU PHẦN CỨNG CHO LOCAL AI:${NC}"
    echo -e "┌─────────────────────────────────────────────────────────────────┐"
    echo -e "│  Model              │ RAM tối thiểu │ RAM khuyến nghị │ Vision │"
    echo -e "├─────────────────────────────────────────────────────────────────┤"
    echo -e "│  gemma3:2b          │    2 GB       │     3 GB        │  ✅    │"
    echo -e "│  qwen2.5vl:3b       │    3 GB       │     4 GB        │  ✅    │"
    echo -e "│  gemma3:4b          │    4 GB       │     5 GB        │  ✅    │"
    echo -e "│  qwen2.5vl:7b       │    6 GB       │     8 GB        │  ✅    │"
    echo -e "│  gemma3:12b         │    8 GB       │    12 GB        │  ✅    │"
    echo -e "│  llava:13b          │   10 GB       │    16 GB        │  ✅    │"
    echo -e "│  gemma3:27b         │   18 GB       │    24 GB        │  ✅    │"
    echo -e "│  llava:34b          │   20 GB       │    32 GB        │  ✅    │"
    echo -e "└─────────────────────────────────────────────────────────────────┘"
    echo -e "   💡 Tất cả model trên đều hỗ trợ Vision (phân tích ảnh camera)"
    echo -e "   💡 GPU NVIDIA/AMD tăng tốc đáng kể — CPU vẫn chạy được"
    echo -e "   💡 RAM máy này: ${BOLD}${TOTAL_RAM} MB${NC}\n"
